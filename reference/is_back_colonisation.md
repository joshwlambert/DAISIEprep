...
A character string or FALSE. Character string is in the format
ancestral_node -\> focal_node, where the ancestral node is not on
mainland but the focal node is.

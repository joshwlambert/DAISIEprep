...
#| fig.alt: >
#|   A phylogenetic tree with 10 species, with tip labels of bird_a to bird_j.
#|   There is a x-axis labelled Time (Millon years ago) starting at just over
#|   1.5 and going to 0. Phylogeny tips are labelled with coloured points, and
#|   there is a legend titled Endemicity status with a red point for endemic,
#|   green for nonendemic and blue for not_present. bird a, b, c and d are
#|   endemic, bird f is nonendemic, all other species are not present.
set.seed(
  1,
...
```{r}
#| fig.alt: >
#|   A schematic of biogeographic ancestral state reconstruction models:
#|   character mapping, DIVA, DEC (GeoSSE, Lagrange), BayArea, BioGeoBEARS, 
#|   with checkboxes for which processes are included in each model, processes
#|   are: dispersal, extinction, range-switching, sympatry (narrow), sympatry
#|   (widespread), sympatry (subset), vicariance (narrow),
#|   vicariance (widespread), founder. Each model contains a subset of these
#|   processes except BioGeoBEARS which has a parameter for each process.
...
#| fig.alt: >
#|   A phylogenetic tree with 20 species, with tip labels of bird_a to bird_t.
#|   There is a x-axis labelled Time (Millon years ago) starting at around
#|   4 and going to 0. Phylogeny tips and nodes are labelled with coloured
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic and blue for not_present. There is a mix
#|   of endemic, nonendemic and not_present tips and nodes, the root node is 
#|   not_present.
# Add endemicity data
...
#| fig.alt: >
#|   A phylogenetic tree with 20 species, with tip labels of bird_a to bird_t.
#|   There is a x-axis labelled Time (Millon years ago) starting just over
#|   7.5 and going to 0. Phylogeny tips are labelled with coloured points,
#|   and there is a legend titled Endemicity status with a red point for
#|   endemic, green for nonendemic and blue for not_present. There is a mix
#|   of endemic, nonendemic and not_present tips.
...
#|   A phylogenetic tree with 20 species, with tip labels of bird_a to bird_t.
#|   There is a x-axis labelled Time (Millon years ago) starting just over
#|   7.5 and going to 0. Phylogeny tips and nodes are labelled with coloured
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic and blue for not_present. There is a mix
#|   of endemic, nonendemic and not_present tips, nodes are a mix of endemic
#|   and not_present, the root node is endemic.
...
#| fig.alt: >
#|   A phylogenetic tree with 20 species, with tip labels of bird_a to bird_t.
#|   There is a x-axis labelled Time (Millon years ago) starting around 4 and
#|   going to 0. Phylogeny tips are labelled with coloured points, and there
#|   is a legend titled Endemicity status with a red point for endemic, green
#|   for nonendemic and blue for not_present. There is a mix of endemic,
#|   nonendemic and not_present tips.
set.seed(
  2,
  kind = "Mersenne-Twister",
  normal.kind = "Inversion",
...
#|   A phylogenetic tree with 20 species, with tip labels of bird_a to bird_t.
#|   There is a x-axis labelled Time (Millon years ago) starting around 4 and
#|   going to 0. Phylogeny tips and nodes are labelled with coloured points,
#|   and there is a legend titled Endemicity status with a red point for
#|   endemic, green for nonendemic and blue for not_present. There is a mix of
#|   endemic, nonendemic and not_present tips, almost all nodes are not_present,

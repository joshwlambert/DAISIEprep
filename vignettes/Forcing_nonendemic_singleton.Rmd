...
#|   for endemic, and blue for not_present. Plant i, h and g and the two
#|   ancestral nodes leading to them are nonendemic, all other tips and nodes
...
#|   1.5 and going to 0. Phylogeny tips and nodes are labelled with coloured
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic, and blue for not_present. Plant a, b,
#|   c, d, and e are endemic, Plant i, h and j are nonendemic and Plant f and j
#|   are not present on the island. Ancestral nodes are a mix of endemic and 
#|   nonendemic and the root node is not present.
...
```{r, fig.height=5, fig.width=8}
#| fig.alt: >
#|   A phylogenetic tree with 5 species, with tip labels of Plant_a to Plant_e.
#|   There is a x-axis labelled Time (Millon years ago) starting at just over
#|   0.75 and going to 0. Phylogeny tips and nodes are labelled with coloured
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic, and blue for not_present. Plant a and b
#|   are endemic, Plant c and d are nonendemic, and Plant e is not present. The
#|   node ancestral to Plant c and d is nonendemic, all other nodes are endemic.
...
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic, and blue for not_present. Plant a, b,
#|   c, d, and f are endemic, Plant e is nonendemic, and others are not present.
#|   All ancestral nodes are endemic, except the root and nodes ancestral to 
#|   Plant g, h, i.
set.seed(
  1,
  kind = "Mersenne-Twister",
...
#|   1.5 and going to 0. Phylogeny tips and nodes are labelled with coloured
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic and blue for not_present. Plant a, b, c, d, e and f are
#|   endemic and have endemic ancestral nodes, Plant h, i, j, and k are not
#|   present, and all other nodes are not_present.
endemicity_status <- c("endemic", "endemic", "endemic", 
...
#|   1.5 and going to 0. Phylogeny tips and nodes are labelled with coloured
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic and blue for not_present. Plant b, c, d
#|   and e are endemic, Plant b, i and h are nonendemic, and Plant a, f, g and j
#|   are not_present. Nodes are a mix of endemic, nonendemic and not_present,
#|   the root node is not_present.
set.seed(
  1,
  kind = "Mersenne-Twister",
  normal.kind = "Inversion",
...
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic and blue for not_present. Plant b, c, d
#|   and e are endemic, Plant i and h are nonendemic, and Plant a, f, g and j
#|   are not_present. Nodes are a mix of endemic, nonendemic and not_present,
#|   the root node is not_present.

...
We are now ready to extract the island clade. In this case, the crown
node is inferred as present on the island, such that the time of the
colonisation event cannot be estimated from the tree:

...
Given the approximately linear relationship between the size of the phylogeny and time required for extraction in the above plots we fit a power law to the mean run time (mean across the replicates) we find:

...
![DAISIEprep package hex logo](../man/figures/logo.png)
...
```{r plot phylo}
#| fig.alt: >
#|   A phylogenetic tree with 10 species, with tip labels of Plant_a to Plant_j.
...
#|   green for nonendemic and blue for not_present. Plant i is endemic, Plant g
#|   is nonendemic, all other species are not present on the island.
...
#|   A phylogenetic tree with 10 species, with tip labels of Plant_a to Plant_j.
#|   There is a x-axis labelled Time (Millon years ago) starting at just over
#|   1.5 and going to 0. Phylogeny tips and nodes are labelled with coloured
#|   points, and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic and blue for not_present. Plant i is
#|   endemic, Plant g is nonendemic, all other species are not present on the
#|   island. All nodes are not present except the two nodes ancestral to 
#|   Plant i, h and g which are nonendemic. 
plot_phylod(phylod = phylod)
```
...
```{r}
#| fig.alt: >
#|   A phylogenetic tree for the genus Coccyzus with 20 species, with tip
#|   labels with the genus and species name, and a location and marker suffix,
#|   e.g. Coccyzus_melacoryphus_GALAPAGOS_L571A.
...
#|   A phylogenetic tree for the genus Coccyzus with 20 species, with tip
#|   labels with the genus and species name, and a location and marker suffix,
#|   e.g. Coccyzus_melacoryphus_GALAPAGOS_L571A. There is a x-axis labelled
#|   Time (Millon years ago) starting at just over 7.5 and going to 0. 
#|   Phylogeny tips are labelled with coloured points, and there is a legend
#|   titled Endemicity status with a red point for nonendemic and blue for 
#|   not_present. Coccyzus melacoryphus Galapagos tips are nonendemic, all other
#|   species are not_present.
...
#|   e.g. Coccyzus_melacoryphus_GALAPAGOS_L571A. There is a x-axis labelled
#|   Time (Millon years ago) starting at just over 7.5 and going to 0. 
#|   Phylogeny tips and nodes are labelled with coloured points, and there
#|   is a legend titled Endemicity status with a red point for nonendemic and
#|   blue for not_present. Coccyzus melacoryphus Galapagos tips are nonendemic,
#|   and the ancestral node to these two species is nonendemic, all other tips
#|   and nodes are not_present.
plot_phylod(phylod = phylod)
```
...
#| fig.alt: >
#|   A phylogenetic tree for the Darwin's finches with 16 species, with tip
#|   labels with the genus abbreviated to a single letter and species name 
#|   abbreviated, e.g. C par. There is a x-axis labelled Time (Millon years 
#|   ago) starting at around 3 and going to 0. Phylogeny tips and nodes are
#|   labelled with coloured points, and there is a legend titled Endemicity
#|   status with a red point for endemic, green for nonendemic, and blue for
#|   not_present. All species are endemic at the tips and nodes, except T bi
#|   (an outgroup), which is not_present, and the root node which is 
#|   nonendemic.

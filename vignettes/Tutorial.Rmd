...
# This is giving a warning message for the Darwins finches: 
...
# There is something wrong with this datalist
```{r} 
data_list <- create_daisie_data(
  data = island_tbl, 
  island_age = 4, 
...
# This works well, creating a stac 9, but I'm not sure if this is allowed in the ML, because there is no colonisation time
```{r}
island_tbl <- add_island_colonist(
  island_tbl = island_tbl, 
  clade_name = "Bird_3", 

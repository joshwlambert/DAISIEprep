...
#|   except Plant_e. There are 2 Plant_d species Plant_d_a and Plant_d_b.
#|   There is a x-axis labelled Time (Millon years ago) starting at just over
#|   1.5 and going to 0. Phylogeny tips are labelled with coloured points,
#|   and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic and blue for not_present. Plant i is
#|   endemic, Plant d_a and d_b are nonendemic, all other species are 
#|   not present.
set.seed(1)
tree <- ape::rcoal(10)
...
#|   and there is a legend titled Endemicity status with a red point
#|   for endemic, green for nonendemic and blue for not_present. Plant i is
#|   endemic, Plant d_a is nonendemic, all other species are not present.
...
#|   1.5 and going to 0. Phylogeny tips are labelled with coloured points,
#|   and there is a legend titled Endemicity status with a red point
#|   for endemic and blue for not_present. Plant d_a, d_b and i are endemic,
#|   all other species are not present.
...
#| fig.alt: >
#|   A phylogenetic tree with 10 species, with tip labels of Plant_a to Plant_g.
#|   There are 4 Plant_d species Plant_d_a Plant_d_b, Plant_d_c and Plant_d_d.
#|   There is a x-axis labelled Time (Millon years ago) starting at just over
#|   1.5 and going to 0. Phylogeny tips are labelled with coloured points,
#|   and there is a legend titled Endemicity status with a red point
#|   for endemic and blue for not_present. All Plant d tips and Plant f are
#|   endemic, all other species are not present.
...
#| fig.alt: >
#|   A phylogenetic tree with 10 species, with tip labels of Plant_a to Plant_h.
#|   There are 3 Plant_g species Plant_g_island_a, Plant_g_island_b and 
#|   Plant_g_mainland. There is a x-axis labelled Time (Millon years ago)
#|   starting at just over 1.5 and going to 0. Phylogeny tips are labelled
#|   with coloured points, and there is a legend titled Endemicity status with
#|   a red point for endemic and blue for not_present. All Plant_g_island tips
#|   are endemic, all other tips are not present.
